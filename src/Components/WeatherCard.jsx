...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4 hover:scale-110'>
      ...
      <div className='w-full mx-0 flex justify-center items-center text-3xl font-semibold'>
        {conditions}
      </div>
    </div>
  )
